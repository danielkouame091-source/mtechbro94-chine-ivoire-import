...
if "nom_complet" not in st.session_state:
  st.session_state.nom_complet = "Utilisateur"
  ...
  with col1:
    ...
    if st.button("Se connecter", use_container_width=True):
      ...
      if user_data and user_data[1] == "Actif":
        ...
        )  # Affectation sécurisée du nom complet
...
st.sidebar.write(f"**Utilisateur :** {st.session_state.get('nom_complet', 'Utilisateur')}")
